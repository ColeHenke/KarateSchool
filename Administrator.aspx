            ...
            <table style="width:100%;">
                <tr>
                    <td class="auto-style2">
                        ...
                        <br />
                        <asp:Label runat="server" Text="User ID:" ID="memberIdLabel"></asp:Label>
                        <asp:TextBox runat="server" ID="memberIdTextBox"></asp:TextBox>
                        <br />
                    ...
                    <td class="auto-style2">
                        ...
                        <asp:TextBox runat="server" ID="instUserName"></asp:TextBox>
                        <br />
                        <asp:Label runat="server" Text="Password:" ID="Label3"></asp:Label>
                        <asp:TextBox runat="server" ID="instPass"></asp:TextBox>
                        <br />
                        ...
                        <br />
                        <asp:Label runat="server" Text="User ID:" ID="Label1"></asp:Label>
                        <asp:TextBox runat="server" ID="instUserID"></asp:TextBox>
                        <br />
